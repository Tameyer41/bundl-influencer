          ...
          <main className="flex-1">
            ...
            <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
              ...
              <div className="mt-4 flex sm:mt-0 sm:ml-4">
                <button
                  type="button"
                  className="order-0 ml-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-0 sm:ml-0"
                >
                  Share
                </button>
                <Modal />
              ...
              <div className="align-middle inline-block min-w-full border-b border-gray-200">
                <table className="min-w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-100">
                    {props.projects.map(function (project, idx) {
                      return (
                        <tr key={project.id}>
                          <td className="px-6 py-3 max-w-0 w-full whitespace-nowrap text-sm font-medium text-gray-900 hover:bg-gray-50">
