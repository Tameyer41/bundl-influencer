...
export default function Modal() {
  ...
  if (!data)
    return (
      <button
        type="button"
        className="mx-4 rounded border border-transparent bg-[#0C3D8D] hover:bg-[#3D64A4] transition-colors duration-250 text-white  py-2 px-4 text-sm font-medium shadow-sm"
      >
        Create a project
      </button>
    );
